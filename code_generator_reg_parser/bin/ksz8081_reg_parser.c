...
static bool parse_auto-negotiation_advertisement_register_4 (uint16_t reg16b_val, FILE *out_file_prt, uint8_t reg_addr) {
    bool res = false;
    if (reg16b_val & (1<<15)) {
...
static bool parse_auto-negotiation_link_partner_ability_register_5 (uint16_t reg16b_val, FILE *out_file_prt, uint8_t reg_addr) {
    bool res = false;
    if (reg16b_val & (1<<15)) {
...
static bool parse_auto-negotiation_expansion_register_6 (uint16_t reg16b_val, FILE *out_file_prt, uint8_t reg_addr) {
    bool res = false;
    if (reg16b_val & (1<<4)) {
...
static bool parse_auto-negotiation_next_page_register_7 (uint16_t reg16b_val, FILE *out_file_prt, uint8_t reg_addr) {
    bool res = false;
    if (reg16b_val & (1<<15)) {
