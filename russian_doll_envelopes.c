...
// пройтсь по всей ветке посчитать количество вложенных конвертов сравнить с массимальным если получилось больше то запомить это число
