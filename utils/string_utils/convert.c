...
// static void dtoa_normal (double_t double_data, int32_t double_precision, char
// double_stringified []);
static void ftoa_normal(float_t float_data, int32_t float_precision,
                        char float_stringified[]);
...
bool try_strl2uint64(const char u64l_str[], int32_t u64l_str_len,
                     uint64_t *u64l_value) {
    ...
    if (NULL != u64l_value) {
      ...
      if (u64l_success == true) {
        ...
        if (is_hex_str(u64l_str, u64l_len, &num_shift) == true) {
          u64l_success =
              try_strl2uint64_hex(&u64l_str[num_shift],
                                  u64l_len - ((int32_t)num_shift), u64l_value);
        } else {
...
bool try_strl2int64(const char s64l_str[], int32_t s64l_str_len,
                    int64_t *s64l_value) {
      ...
      *s64l_value = 0;
      ...
      if (s64l_success == true) {
        ...
        if (is_hex_str(s64l_str, s64l_len, &num_shift) == true) {
          s64l_success =
              try_strl2int64_hex(&s64l_str[num_shift],
                                 s64l_len - ((int32_t)num_shift), s64l_value);
        } else {
...
bool try_strl2uint64_hex(const char u64_hex_str[], int32_t u64_hex_str_len,
  ...
  if ((NULL != u64_hex_str) && (NULL != u64_hex_value)) {
    ...
    if (u64_hex_success == true) {
      for (u64_hex_str_index = 0; u64_hex_str_index < u64_hex_len;
           u64_hex_str_index++) {
...
bool try_strl2int64_hex(const char s64_hex_str[], int32_t s64_hex_str_len,
                        int64_t *s64_hex_value) {
  ...
  if ((NULL != s64_hex_str) && (NULL != s64_hex_value)) {
    ...
    if (s64_hex_success == true) {
      for (s64_hex_str_index = 0; s64_hex_str_index < s64_hex_len;
           s64_hex_str_index++) {
        uint8_t s64_hex_str_char = (uint8_t)s64_hex_str[s64_hex_str_index];
        uint8_t s64_hex_str_number = 0U;
        s64_hex_success =
            try_hex_char_to_u8(s64_hex_str_char, &s64_hex_str_number);
...
bool try_strl2uint64_dec(const char u64_dec_str[], int32_t u64_dec_str_len,
                         uint64_t *u64_dec_value) {
  ...
  if (true == is_signed(u64_dec_str[0], &u64l_dec_str_index)) {
    ...
    for (; u64l_dec_str_index < u64_dec_str_len; u64l_dec_str_index++) {
      ...
      u64l_dec_success =
          try_dec_char_to_u8(u64l_dec_str_char, &u64l_dec_str_number);
...
bool try_strl2int64_dec(const char s64_dec_str[], int32_t s64_dec_str_len,
                        int64_t *s64_dec_value) {
  ...
  if ((NULL != s64_dec_str) && (NULL != s64_dec_value)) {
    ...
    if (s64l_dec_success == true) {
      for (; s64l_dec_str_index < s64_dec_str_len; s64l_dec_str_index++) {
        ...
        s64l_dec_success =
            try_dec_char_to_u8(s64_dec_str_char, &s64_dec_str_number);
        if (s64l_dec_success == true) {
          s64_dec_temp_value =
              (s64l_dec_result * 10) + (int64_t)s64_dec_str_number;
...
bool try_strl2uint32(const char u32l_str[], int32_t u32l_str_len,
                     uint32_t *u32l_value) {
  ...
  if ((NULL != u32l_str) && (NULL != u32l_value)) {
    ...
    if (u32l_str_not_empty == false) {
      ...
      if (is_hex_str(u32l_str, u32l_len, &num_shift) == true) {
        u32l_success = try_strl2uint32_hex(
            &u32l_str[num_shift], u32l_len - ((int32_t)num_shift), u32l_value);
      } else {
...
bool try_strl2int32(const char s32l_str[], int32_t s32l_str_len,
                    int32_t *s32l_value) {
  ...
  if (s32l_success == true) {
    ...
    if (is_hex_str(s32l_str, s32l_len, &out_shift) == true) {
      s32l_success = try_strl2int32_hex(
          &s32l_str[out_shift], s32l_len - ((int32_t)out_shift), s32l_value);
    } else {
...
bool try_strl2uint32_hex(const char u32l_hex_str[], int32_t u32l_hex_str_len,
                         uint32_t *u32l_hex_value) {
  uint64_t u32l_hex_result = 0U;
  bool u32l_hex_success =
      try_strl2uint64_hex(u32l_hex_str, u32l_hex_str_len, &u32l_hex_result);
...
bool try_strl2int32_hex(const char s32l_hex_str[], int32_t s32l_hex_str_len,
                        int32_t *s32l_hex_value) {
  int64_t s32l_hex_result = 0;
  bool s32l_hex_success =
      try_strl2int64_hex(s32l_hex_str, s32l_hex_str_len, &s32l_hex_result);

  if ((s32l_hex_success == true) && (s32l_hex_result <= INT32_MAX) &&
      (s32l_hex_result >= INT32_MIN)) {
...
bool try_strl2uint32_dec(const char u32_dec_str[], int32_t u32_dec_str_len,
                         uint32_t *u32_dec_value) {
  uint64_t u32l_dec_result = 0U;
  bool u32l_dec_success =
      try_strl2uint64_dec(u32_dec_str, u32_dec_str_len, &u32l_dec_result);
...
bool try_strl2int32_dec(const char s32_dec_str[], int32_t s32_dec_str_len,
                        int32_t *s32_dec_value) {
  int64_t s32l_dec_result = 0;
  bool s32l_dec_success =
      try_strl2int64_dec(s32_dec_str, s32_dec_str_len, &s32l_dec_result);

  if ((s32l_dec_success == true) && (s32l_dec_result <= INT32_MAX) &&
      (s32l_dec_result >= INT32_MIN)) {
...
bool try_strl2uint16(const char u16l_str[], int32_t u16l_str_len,
                     uint16_t *u16l_value) {
...
bool try_strl2int16(const char s16l_str[], int32_t s16l_str_len,
                    int16_t *s16l_value) {
  int32_t s16l_result = 0;
  bool s16l_success = try_strl2int32(s16l_str, s16l_str_len, &s16l_result);

  if ((s16l_success == true) && (s16l_result <= INT16_MAX) &&
      (s16l_result >= INT16_MIN)) {
...
bool try_strl2uint8(const char u8l_str[], int32_t u8l_str_len,
                    uint8_t *u8l_value) {
...
bool try_strl2int8(const char s8l_str[], int32_t s8l_str_len,
                   int8_t *s8l_value) {
  int32_t s8l_result = 0;
  bool s8l_success = try_strl2int32(s8l_str, s8l_str_len, &s8l_result);

  if ((s8l_success == true) && (s8l_result <= INT8_MAX) &&
      (s8l_result >= INT8_MIN)) {
...
bool try_strl2uint8_hex(const char u8l_hex_str[], int32_t u8l_hex_str_len,
                        uint8_t *u8l_hex_value) {
  uint64_t u8l_hex_result = 0U;
  bool u8l_hex_success =
      try_strl2uint64_hex(u8l_hex_str, u8l_hex_str_len, &u8l_hex_result);
...
bool try_strl2uint16_hex(const char u16l_hex_str[], int32_t u16l_hex_str_len,
                         uint16_t *u16l_hex_value) {
  uint64_t u16l_hex_result = 0U;
  bool u16l_hex_success =
      try_strl2uint64_hex(u16l_hex_str, u16l_hex_str_len, &u16l_hex_result);
...
bool try_strl2int8_hex(const char s8l_hex_str[], int32_t s8l_hex_str_len,
                       int8_t *s8l_hex_value) {
  int64_t s8l_hex_result = 0;
  bool s8l_hex_success =
      try_strl2int64_hex(s8l_hex_str, s8l_hex_str_len, &s8l_hex_result);

  if ((s8l_hex_success == true) && (s8l_hex_result <= INT8_MAX) &&
      (s8l_hex_result >= INT8_MIN)) {
...
bool try_str2bool(const char bool_str[], bool *bool_value) {
  ...
  if ((NULL != bool_str) && (NULL != bool_value)) {
    ...
    if (bool_success == true) {
      for (bool_str_index = 0; bool_str_index < bool_str_len;
           bool_str_index++) {
        uint8_t bool_str_char = (uint8_t)bool_str[bool_str_index];
        bool_tmp_result[bool_str_index] =
            (uint8_t)tolower((int32_t)bool_str_char);
      }
...
bool try_str2float(const char float_str[], float_t *float_value) {
  ...
  if ((NULL != float_value) && (NULL != float_str)) {
    ...
    if ((float_success == true) && (*float_ptr != '\0')) {
      ...
      if ((is_positive == true) && ((hi_pos_bound_exceeded == true) ||
                                    (lo_pos_bound_exceeded == true))) {
        float_success = false;
...
const char *ltoa32_(int32_t s32_data, char s32_stringified[], uint8_t s32_base,
  ...
  for (s32_result_str_index = 0U; s32_result_str_index < s32_result_str_len;
       s32_result_str_index++) {
    s32_stringified[s32_result_str_index] =
        s32_reverse_str[s32_reverse_str_index];
    s32_reverse_str_index--;
  }
...
const char *ltoa64_(int64_t s64_data, char s64_stringified[], uint8_t s64_base,
                    uint32_t *s64_len) {
  ...
  for (s64_result_str_index = 0U; s64_result_str_index < s64_result_str_len;
       s64_result_str_index++) {
    s64_stringified[s64_result_str_index] =
        s64_reverse_str[s64_reverse_str_index];
    s64_reverse_str_index--;
  }
...
const char *utoa32_(uint32_t u32_data, char u32_stringified[], uint8_t u32_base,
                    uint32_t *u32_len) {
  ...
  for (u32_result_str_index = 0U; u32_result_str_index < u32_result_str_len;
       u32_result_str_index++) {
    u32_stringified[u32_result_str_index] =
        u32_reverse_str[u32_reverse_str_index];
    u32_reverse_str_index--;
  }
...
const char *utoa64_(uint64_t u64_data, char u64_stringified[], uint8_t u64_base,
                    uint32_t *u64_len) {
  ...
  for (u64_result_str_index = 0U; u64_result_str_index < u64_result_str_len;
       u64_result_str_index++) {
    u64_stringified[u64_result_str_index] =
        u64_reverse_str[u64_reverse_str_index];
    u64_reverse_str_index--;
  }
...
void dtoa_(double_t double_data_, int32_t double_precision_,
           char double_stringified_[]) {
  (void)double_data_;
  ...
  (void)double_stringified_;
    ...
    switch (__fpclassify(double_data_)) {
#else
    switch (__fpclassifyd (double_data_)) {
        ...
        case FP_ZERO:
        case FP_SUBNORMAL:
            dtoa_normal (double_data_, double_precision_, double_stringified_);
            break;
        case FP_INFINITE:
            (void) strcpy (double_stringified_, "INF");
            break;
        case FP_NAN:
            (void) strcpy (double_stringified_, "NAN");
            break;
        default:
            (void) strcpy (double_stringified_, "???");
            break;
    }
#endif
}
...
static void ftoa_normal(float_t float_data, int32_t float_precision,
  ...
  if (f_precision == 0) {
    (void)utoa64_((uint64_t)f_data, &float_stringified[float_result_str_index],
                  10U, NULL);
  } else {
    uint64_t float_int_part = (uint64_t)f_data;
    uint32_t float_int_part_len = 0U;
    f_data -= (float_t)float_int_part;
    (void)utoa64_(float_int_part, &float_stringified[float_result_str_index],
                  10U, &float_int_part_len);
...
void ftoa_(float_t float_data_, int32_t float_precision_,
           char float_stringified_[]) {
...
uint32_t base64_encode(const uint8_t encode_data[], uint32_t encode_data_size,
                       char encode_result[]) {
  static char basis64[] =
  ...
  while (s > 2U) {
    ...
    basis64_char_index =
        (uint8_t)((encode_data_char_0 & 3U) << 4U) | (encode_data_char_1 >> 4U);
    encode_result[encode_result_index] = basis64[basis64_char_index];
    encode_result_index++;

    basis64_char_index = (uint8_t)((encode_data_char_1 & 0x0fU) << 2U) |
                         (encode_data_char_2 >> 6U);
    encode_result[encode_result_index] = basis64[basis64_char_index];
    encode_result_index++;
...
bool base64_decode(const char decode_str[], int32_t decode_str_len,
                   uint8_t decode_data[], uint32_t *decode_data_size) {
  static const uint8_t basis[] = {
      XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,
      XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,
      XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  XX,  62U, XX,
      XX,  XX,  63U, 52U, 53U, 54U, 55U, 56U, 57U, 58U, 59U, 60U, 61U, XX,  XX,
      XX,  XX,  XX,  XX,  XX,  0U,  1U,  2U,  3U,  4U,  5U,  6U,  7U,  8U,  9U,
      10U, 11U, 12U, 13U, 14U, 15U, 16U, 17U, 18U, 19U, 20U, 21U, 22U, 23U, 24U,
      25U, XX,  XX,  XX,  XX,  XX,  XX,  26U, 27U, 28U, 29U, 30U, 31U, 32U, 33U,
      34U, 35U, 36U, 37U, 38U, 39U, 40U, 41U, 42U, 43U, 44U, 45U, 46U, 47U, 48U,
      49U, 50U, 51U, XX,  XX,  XX,  XX,  XX,
  ...
  *decode_data_size = 0U;
  ...
  if (decode_success == true) {
    while (len > 4) {
      ...
      decode_value = ((uint8_t)(basis[decode_str_char_0] << 2U) |
                      (uint8_t)(basis[decode_str_char_1] >> 4U));
      decode_data[decode_data_index] = decode_value;
      decode_data_index++;

      decode_value = ((uint8_t)(basis[decode_str_char_1] << 4U) |
                      (uint8_t)(basis[decode_str_char_2] >> 2U));
      decode_data[decode_data_index] = decode_value;
      decode_data_index++;

      decode_value = ((uint8_t)(basis[decode_str_char_2] << 6U) |
                      basis[decode_str_char_3]);
      decode_data[decode_data_index] = decode_value;
      decode_data_index++;
...
static bool try_hex_char_to_u8(uint8_t hex_char,
                               uint8_t *hex_char_to_u8_value) {
...
static bool try_dec_char_to_u8(uint8_t dec_char,
                               uint8_t *dec_char_to_u8_value) {
  ...
  if ((NULL != str_to_check) && (NULL != out_shift)) {
    ...
    if (false == is_dec_str_res) {
      ...
      if (true == len_check_passed) {
        ...
        if ((str_to_check_len - ((int32_t)out_shift_loc) - space) ==
            validHexCnt) {
...
static bool is_true(const char *true_str_to_check) {
  ...
  if (NULL != true_str_to_check) {
    ...
    if ((check_for_yes == 0) || (check_for_true == 0) || (check_for_on == 0) ||
        (check_for_1 == 0)) {
      is_true_result = true;
    }
  }
...
static bool is_false(const char *false_str_to_check) {
  ...
  if (NULL != false_str_to_check) {
    ...
    if ((check_for_no == 0) || (check_for_false == 0) || (check_for_off == 0) ||
        (check_for_0 == 0)) {
...
const char *utoa_bin16(uint16_t u16_bin_data) {
  ...
  static char outBitStr16[sizeof("0000_0000_0000_0000") + 1U] =
      "0000_0000_0000_0000";
  while (mask16 != 0U) {
...
const char *utoa_bin24(uint32_t u32_bin_data) {
  ...
  static char outBitStr24[sizeof("0000_0000_0000_0000_0000_0000") + 1U] =
...
const char *utoa_bin32(uint32_t u32_bin_data) {
  ...
  static char outBitStr32[sizeof("0000_0000_0000_0000_0000_0000_0000_0000") +
                          1U] = "0000_0000_0000_0000_0000_0000_0000_0000";
  while (mask32 != 0U) {
...
bool try_strl2ipv4(const char str__tsl2i4[], int32_t str_len__tsl2i4,
                   uint32_t *ipv4_ptr__tsl2i4) {
...
bool try_str2mac(const char macStr[], uint8_t *outMacAddr) {
  ...
  numberOfVariables =
      sscanf(macStr, "%x:%x:%x:%x:%x:%x", (unsigned int *)&outMacAddr[0],
             (unsigned int *)&outMacAddr[1], (unsigned int *)&outMacAddr[2],
             (unsigned int *)&outMacAddr[3], (unsigned int *)&outMacAddr[4],
...
bool try_strl2ipv6(const char in_ip_str[], int32_t str_len,
                   uint16_t *ipv6_arr) {
...
#define TRY_STRL2IPV6_MIN_LENGTH 15 /*0:0:0:0:0:0:0:0*/
  ...
  if (in_ip_str == NULL) {
    ...
    if (8 != (val_ip6[0] + val_ip6[1] + val_ip6[2] + val_ip6[3] + val_ip6[4] +
              val_ip6[5] + val_ip6[6] + val_ip6[7])) {
      res = false;
    }
...
uint32_t assemble_uint32(uint8_t byte1, uint8_t byte2, uint8_t byte3,
                         uint8_t byte4) {
  uint32_t v32 = 0;
