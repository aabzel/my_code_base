...
bool parse_serial(char *in_str, uint16_t in_strLen,
                  uint64_t *outSerial64bNumber);
...
int get_index_in_string(char *expression, int in_strLen, int operandNum,
...
bool parse_substr_name(const char *const in_str, uint16_t in_strLen,
                       char *const outStr, char openBracket,
                       char closedBracket);
