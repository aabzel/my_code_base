...
#ifdef ENABLE_MULTICORE
#define FIFO_CHAR_INIT(size, data)                                                                                     \
    { FIFO_INDEX_INIT (size), data, IC_MUTEX_INVALID }
#define FIFO_CHAR_INIT_WITH_IC_MUTEX(size, data, mutex)                                                                \
    { FIFO_INDEX_INIT (size), data, mutex }
#else
#define FIFO_CHAR_INIT(size, data)                                                                                     \
    { FIFO_INDEX_INIT (size), data }
#endif
