...
const char *get_spaces_str (uint32_t spaces_length) {
    static char szSpaces [101] = TEN_SPACES TEN_SPACES TEN_SPACES TEN_SPACES TEN_SPACES TEN_SPACES TEN_SPACES TEN_SPACES TEN_SPACES TEN_SPACES;
