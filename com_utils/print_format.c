...
static void print_format_flt (ostream_t *flt__stream, const char flt__format[], uint8_t flt__values_count,
                              float_t flt__value_1, float_t flt__value_2, float_t flt__value_3,
...
static void print_format_dbl (ostream_t *dbl__stream, const char dbl__format[], uint8_t dbl__values_count,
                              double_t dbl__value_1, double_t dbl__value_2, double_t dbl__value_3,
...
void print_format_flt_1 (ostream_t *flt_1__stream, const char flt_1__format[], float_t flt_1__value_1,
...
void print_format_flt_2 (ostream_t *flt_2__stream, const char flt_2__format[], float_t flt_2__value_1,
                         float_t flt_2__value_2, const char flt_2__ending[]) {
    print_format_flt (flt_2__stream, flt_2__format, 2U, flt_2__value_1, flt_2__value_2, flt_2__value_2, flt_2__ending);
}

void print_format_flt_3 (ostream_t *flt_3__stream, const char flt_3__format[], float_t flt_3__value_1,
                         float_t flt_3__value_2, float_t flt_3__value_3, const char flt_3__ending[]) {
    print_format_flt (flt_3__stream, flt_3__format, 3U, flt_3__value_1, flt_3__value_2, flt_3__value_3, flt_3__ending);
}

void print_format_dbl_1 (ostream_t *dbl_1__stream, const char dbl_1__format[], double_t dbl_1__value_1,
...
void print_format_dbl_2 (ostream_t *dbl_2__stream, const char dbl_2__format[], double_t dbl_2__value_1,
                         double_t dbl_2__value_2, const char dbl_2__ending[]) {
    print_format_dbl (dbl_2__stream, dbl_2__format, 2U, dbl_2__value_1, dbl_2__value_2, dbl_2__value_2, dbl_2__ending);
}

void print_format_dbl_3 (ostream_t *dbl_3__stream, const char dbl_3__format[], double_t dbl_3__value_1,
                         double_t dbl_3__value_2, double_t dbl_3__value_3, const char dbl_3__ending[]) {
