...
static void print_format_s64(ostream_t * s64__stream, const char s64__format[], uint8_t s64__values_count, int64_t  s64__value_1, int64_t  s64__value_2, int64_t  s64__value_3, const char s64__ending[]);
static void print_format_u64(ostream_t * u64__stream, const char u64__format[], uint8_t u64__values_count, uint64_t u64__value_1, uint64_t u64__value_2, uint64_t u64__value_3, const char u64__ending[]);
static void print_format_s32(ostream_t * s32__stream, const char s32__format[], uint8_t s32__values_count, int32_t  s32__value_1, int32_t  s32__value_2, int32_t  s32__value_3, const char s32__ending[]);
static void print_format_u32(ostream_t * u32__stream, const char u32__format[], uint8_t u32__values_count, uint32_t u32__value_1, uint32_t u32__value_2, uint32_t u32__value_3, const char u32__ending[]);
static void print_format_flt(ostream_t * flt__stream, const char flt__format[], uint8_t flt__values_count, float_t  flt__value_1, float_t  flt__value_2, float_t  flt__value_3, const char flt__ending[]);
static void print_format_dbl(ostream_t * dbl__stream, const char dbl__format[], uint8_t dbl__values_count, double_t dbl__value_1, double_t dbl__value_2, double_t dbl__value_3, const char dbl__ending[]);

void print_format_s64_1(ostream_t * s64_1__stream, const char s64_1__format[], int64_t s64_1__value_1, const char s64_1__ending[]) {
    print_format_s64(s64_1__stream, s64_1__format, 1U, s64_1__value_1, s64_1__value_1, s64_1__value_1, s64_1__ending);
}

void print_format_s64_2(ostream_t * s64_2__stream, const char s64_2__format[], int64_t  s64_2__value_1, int64_t  s64_2__value_2, const char s64_2__ending[]) {
    print_format_s64(s64_2__stream, s64_2__format, 2U, s64_2__value_1, s64_2__value_2, s64_2__value_2, s64_2__ending);
}

void print_format_s64_3(ostream_t * s64_3__stream, const char s64_3__format[], int64_t  s64_3__value_1, int64_t  s64_3__value_2, int64_t  s64_3__value_3, const char s64_3__ending[]) {
    print_format_s64(s64_3__stream, s64_3__format, 3U, s64_3__value_1, s64_3__value_2, s64_3__value_3, s64_3__ending);
}

void print_format_u64_1(ostream_t * u64_1__stream, const char u64_1__format[], uint64_t u64_1__value_1, const char u64_1__ending[]) {
    print_format_u64(u64_1__stream, u64_1__format, 1U, u64_1__value_1, u64_1__value_1, u64_1__value_1, u64_1__ending);
}

void print_format_u64_2(ostream_t * u64_2__stream, const char u64_2__format[], uint64_t u64_2__value_1, uint64_t u64_2__value_2, const char u64_2__ending[]) {
    print_format_u64(u64_2__stream, u64_2__format, 2U, u64_2__value_1, u64_2__value_2, u64_2__value_2, u64_2__ending);
}

void print_format_u64_3(ostream_t * u64_3__stream, const char u64_3__format[], uint64_t u64_3__value_1, uint64_t u64_3__value_2, uint64_t u64_3__value_3, const char u64_3__ending[]) {
    print_format_u64(u64_3__stream, u64_3__format, 3U, u64_3__value_1, u64_3__value_2, u64_3__value_3, u64_3__ending);
}

void print_format_s32_1(ostream_t* s32_1__stream, const char s32_1__format[], int32_t  s32_1__value_1, const char s32_1__ending[]) {
    print_format_s32(s32_1__stream, s32_1__format, 1U, s32_1__value_1, s32_1__value_1, s32_1__value_1, s32_1__ending);
}

void print_format_s32_2(ostream_t* s32_2__stream, const char s32_2__format[], int32_t  s32_2__value_1, int32_t  s32_2__value_2, const char s32_2__ending[]) {
    print_format_s32(s32_2__stream, s32_2__format, 2U, s32_2__value_1, s32_2__value_2, s32_2__value_2, s32_2__ending);
}

void print_format_s32_3(ostream_t* s32_3__stream, const char s32_3__format[], int32_t  s32_3__value_1, int32_t  s32_3__value_2, int32_t  s32_3__value_3, const char s32_3__ending[]) {
    print_format_s32(s32_3__stream, s32_3__format, 3U, s32_3__value_1, s32_3__value_2, s32_3__value_3, s32_3__ending);
}

void print_format_u32_1(ostream_t* u32_1__stream, const char u32_1__format[], uint32_t u32_1__value_1, const char u32_1__ending[]) {
    print_format_u32(u32_1__stream, u32_1__format, 1U, u32_1__value_1, u32_1__value_1, u32_1__value_1, u32_1__ending);
}

void print_format_u32_2(ostream_t* u32_2__stream, const char u32_2__format[], uint32_t u32_2__value_1, uint32_t u32_2__value_2, const char u32_2__ending[]) {
    print_format_u32(u32_2__stream, u32_2__format, 2U, u32_2__value_1, u32_2__value_2, u32_2__value_2, u32_2__ending);
}

void print_format_u32_3(ostream_t* u32_3__stream, const char u32_3__format[], uint32_t u32_3__value_1, uint32_t u32_3__value_2, uint32_t u32_3__value_3, const char u32_3__ending[]) {
    print_format_u32(u32_3__stream, u32_3__format, 3U, u32_3__value_1, u32_3__value_2, u32_3__value_3, u32_3__ending);
}

void print_format_flt_1(ostream_t* flt_1__stream, const char flt_1__format[], float_t  flt_1__value_1, const char flt_1__ending[]) {
    print_format_flt(flt_1__stream, flt_1__format, 1U, flt_1__value_1, flt_1__value_1, flt_1__value_1, flt_1__ending);
}

void print_format_flt_2(ostream_t* flt_2__stream, const char flt_2__format[], float_t  flt_2__value_1, float_t  flt_2__value_2, const char flt_2__ending[]) {
    print_format_flt(flt_2__stream, flt_2__format, 2U, flt_2__value_1, flt_2__value_2, flt_2__value_2, flt_2__ending);
}

void print_format_flt_3(ostream_t* flt_3__stream, const char flt_3__format[], float_t  flt_3__value_1, float_t  flt_3__value_2, float_t  flt_3__value_3, const char flt_3__ending[]) {
    print_format_flt(flt_3__stream, flt_3__format, 3U, flt_3__value_1, flt_3__value_2, flt_3__value_3, flt_3__ending);
}

void print_format_dbl_1(ostream_t* dbl_1__stream, const char dbl_1__format[], double_t dbl_1__value_1, const char dbl_1__ending[]) {
    print_format_dbl(dbl_1__stream, dbl_1__format, 1U, dbl_1__value_1, dbl_1__value_1, dbl_1__value_1, dbl_1__ending);
}

void print_format_dbl_2(ostream_t* dbl_2__stream, const char dbl_2__format[], double_t dbl_2__value_1, double_t dbl_2__value_2, const char dbl_2__ending[]) {
    print_format_dbl(dbl_2__stream, dbl_2__format, 2U, dbl_2__value_1, dbl_2__value_2, dbl_2__value_2, dbl_2__ending);
}

void print_format_dbl_3(ostream_t* dbl_3__stream, const char dbl_3__format[], double_t dbl_3__value_1, double_t dbl_3__value_2, double_t dbl_3__value_3, const char dbl_3__ending[]) {
...
static void print_format_s64(ostream_t * s64__stream, 
                            const char s64__format[],
                            uint8_t s64__values_count,
                            int64_t s64__value_1,
                            int64_t s64__value_2,
                            int64_t s64__value_3,
                            const char s64__ending[]) {
    uint32_t s64__fmt_index = 0U;
    uint32_t s64__fmt_len   = strlen(s64__format);

    int64_t s64__values[3];
...
static void print_format_u64(ostream_t * u64__stream,
                            const char u64__format[],
                            uint8_t u64__values_count,
                            uint64_t u64__value_1,
                            uint64_t u64__value_2,
                            uint64_t u64__value_3,
...
static void print_format_s32(ostream_t * s32__stream,
                            const char s32__format[],
                            uint8_t s32__values_count, 
                            int32_t  s32__value_1,
                            int32_t  s32__value_2,
                            int32_t  s32__value_3,
...
static void print_format_u32(ostream_t * u32__stream,
                            const char u32__format[],
                            uint8_t u32__values_count, 
                            uint32_t u32__value_1,
                            uint32_t u32__value_2,
                            uint32_t u32__value_3,
...
static void print_format_flt(ostream_t * flt__stream,
                            const char flt__format[],
                            uint8_t flt__values_count, 
                            float_t  flt__value_1,
                            float_t  flt__value_2,
                            float_t  flt__value_3,
                            const char flt__ending[]) {
    uint32_t flt__fmt_index = 0U;
    uint32_t flt__fmt_len   = strlen(flt__format);

    float_t flt__values[3];
    ...
    while (flt__fmt_index < flt__fmt_len) {
        ...
        if (is_format_string(&flt__format[flt__fmt_index], &flt__arg_index) == true) {
            if (flt__arg_index < flt__values_count)  {
                oputs(flt__stream, rx_ftoa(flt__values[flt__arg_index]));
            }
            flt__fmt_index += 3U;
        } else {
...
static void print_format_dbl(ostream_t * dbl__stream,
                            const char dbl__format[],
                            uint8_t dbl__values_count, 
                            double_t dbl__value_1,
                            double_t dbl__value_2,
                            double_t dbl__value_3,
                            const char dbl__ending[]) {
    uint32_t dbl__fmt_index = 0U;
    uint32_t dbl__fmt_len   = strlen(dbl__format);

    double_t dbl__values[3];
